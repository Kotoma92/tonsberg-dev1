...
namespace OnyxTestApp
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="urn:ec.europa.eu:taxud:vies:services:checkVat", ConfigurationName="OnyxTestApp.checkVatPortType")]
    public interface checkVatPortType
    {
        ...
        System.Threading.Tasks.Task<OnyxTestApp.checkVatResponse> checkVatAsync(OnyxTestApp.checkVatRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<OnyxTestApp.checkVatApproxResponse> checkVatApproxAsync(OnyxTestApp.checkVatApproxRequest request);
    }
    ...
    public partial class checkVatApproxResponse
    {
        ...
        public checkVatApproxResponse(
                    ...
                    string traderCity, 
                    OnyxTestApp.matchCode traderNameMatch, 
                    OnyxTestApp.matchCode traderCompanyTypeMatch, 
                    OnyxTestApp.matchCode traderStreetMatch, 
                    OnyxTestApp.matchCode traderPostcodeMatch, 
                    OnyxTestApp.matchCode traderCityMatch, 
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface checkVatPortTypeChannel : OnyxTestApp.checkVatPortType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class checkVatPortTypeClient : System.ServiceModel.ClientBase<OnyxTestApp.checkVatPortType>, OnyxTestApp.checkVatPortType
    {
        ...
        public System.Threading.Tasks.Task<OnyxTestApp.checkVatResponse> checkVatAsync(OnyxTestApp.checkVatRequest request)
        {
            return base.Channel.checkVatAsync(request);
        }
        
        public System.Threading.Tasks.Task<OnyxTestApp.checkVatApproxResponse> checkVatApproxAsync(OnyxTestApp.checkVatApproxRequest request)
        {
